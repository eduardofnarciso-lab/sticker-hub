  ...
  if (waUrl) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6 text-center gap-6">
        ...
        <div>
          <h1 className="text-2xl font-black text-green-700">Pedido registrado!</h1>
          <p className="text-muted-foreground mt-2 text-sm">
            Toque no botão abaixo para abrir o WhatsApp e confirmar com o vendedor.
          </p>
        </div>
        <a
          href={waUrl}
          ...
          className="w-full max-w-sm flex items-center justify-center gap-3 bg-green-600 hover:bg-green-700 text-white font-bold text-lg rounded-2xl py-4 shadow-lg"
        >
